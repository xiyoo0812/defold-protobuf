...
dmExtension::Result AppInitializePB(dmExtension::AppParams* params)
{
    return dmExtension::RESULT_OK;
}

dmExtension::Result InitializePB(dmExtension::Params* params)
{
    // Init Lua
    LuaInit(params->m_L);
...
dmExtension::Result AppFinalizePB(dmExtension::AppParams* params)
{
    return dmExtension::RESULT_OK;
}

dmExtension::Result FinalizePB(dmExtension::Params* params)
{
    return dmExtension::RESULT_OK;
}
...
DM_DECLARE_EXTENSION(pb, LIB_NAME, AppInitializePB, AppFinalizePB, InitializePB, 0, 0, FinalizePB)